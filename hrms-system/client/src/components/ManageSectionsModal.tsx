...
export default function ManageSectionsModal({ isOpen, onClose, onSectionsUpdated }: ManageSectionsModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-[#4A1726]/70 backdrop-blur-xs flex items-center justify-center p-4">
      <div className="bg-[#F8F5F1] rounded-3xl border border-[#EAE4DC] shadow-2xl w-full max-w-3xl p-6 space-y-5 max-h-[90vh] overflow-y-auto relative animate-scale-in">
        {/* Header */}
        <div className="flex items-center justify-between border-b border-[#EAE4DC] pb-3.5">
          <div>
            <h3 className="font-extrabold text-[#4A1726] text-lg flex items-center gap-2">
        ...
        <form onSubmit={handleAddSection} className="p-4 rounded-2xl bg-white border border-[#EAE4DC] space-y-3 shadow-xs">
          <div className="text-xs font-black uppercase text-[#4A1726] tracking-wider flex items-center gap-1.5 border-b border-[#EAE4DC] pb-2">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            <div>
              ...
              <select
                ...
                className="w-full px-2.5 py-1.5 rounded-xl border border-[#EAE4DC] bg-[#F8F5F1] text-xs font-semibold text-[#4A1726] focus:outline-none"
              >
        ...
        <div className="p-4 rounded-2xl bg-white border border-[#EAE4DC] space-y-3 shadow-xs">
          <div className="flex items-center justify-between border-b border-[#EAE4DC] pb-2.5">
            <div className="text-xs font-black uppercase text-[#4A1726] tracking-wider">
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="px-2.5 py-1 rounded-xl border border-[#EAE4DC] bg-[#F8F5F1] text-xs font-bold text-[#4A1726]"
              >
          ...
          <div className="overflow-x-auto max-h-64 overflow-y-auto">
            <table className="w-full text-left text-xs border-collapse">
              <thead>
                <tr className="border-b border-[#EAE4DC] text-[10.5px] font-black uppercase text-[#777777] bg-[#F8F5F1]">
              ...
              <tbody className="divide-y divide-[#EAE4DC]/60 font-medium">
                {filtered.length > 0 ? (
                  filtered.map((sec, idx) => {
                        ...
                        <tr key={sec.id} className="bg-amber-50">
                          ...
                          <td className="py-2 px-3">
                            <select
                              ...
                              className="px-2 py-1 rounded-lg border border-[#EAE4DC] bg-white text-xs font-bold"
                            >
                              {departmentOptions.map(d => (
                                <option key={d} value={d}>{d}</option>
                              ))}
                          ...
                          <td className="py-2 px-3">
                            <input
                              ...
                              className="px-2 py-1 rounded-lg border border-[#EAE4DC] bg-white text-xs"
                            />
                          </td>
                    ...
                    return (
                      <tr key={sec.id} className="hover:bg-black/5 transition-colors">
                        ...
                        <td className="py-2.5 px-3 font-bold text-[#4A1726]">{sec.department}</td>
                        <td className="py-2.5 px-3 font-black text-[#C6A15B]">{sec.section_name}</td>
        ...
        {/* Modal Footer */}
        <div className="flex justify-end border-t border-[#EAE4DC] pt-3">
          <button
            onClick={onClose}
