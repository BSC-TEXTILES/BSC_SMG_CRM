    ...
    <div className="min-h-screen bg-[#F8F5F1] flex">
      ...
      <div className="flex-1 lg:pl-64 flex flex-col min-w-0">
        ...
        <main className="p-4 lg:p-6 space-y-6 flex-1 overflow-y-auto">
          ...
          {/* Navigation Tabs */}
          <div className="flex items-center gap-2 border-b border-[#EAE4DC] pb-1 overflow-x-auto scrollbar-none text-xs font-bold">
            {tabs.map(t => {
              const Icon = t.icon;
              return (
                <button
                  ...
                  className={`
                    ...
                    ${activeTab === t.key 
                      ? 'bg-[#4A1726] text-white shadow-md font-extrabold' 
                      : 'bg-white text-[#555555] border border-[#EAE4DC] hover:bg-[#F8F5F1]'}
                  `}
                >
          ...
          {activeTab === 'users' && (
            <div className="space-y-6 animate-fade-in">
              ...
              <div className="card-glass p-5 border-2 border-[#C6A15B]/30 space-y-3 bg-gradient-to-r from-amber-50/40 to-amber-100/20">
                <div className="flex items-center justify-between border-b border-[#C6A15B]/30 pb-2">
                  ...
                  <span className="text-[10px] font-black text-[#C6A15B] bg-amber-200/60 px-2 py-0.5 rounded-full uppercase">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 text-xs font-semibold">
                  <div className="p-3 bg-white rounded-xl border border-[#EAE4DC]">
                    ...
                    <div className="font-extrabold text-[#4A1726] font-mono mt-0.5">admin@bsctextiles.com</div>
                    <div className="text-[11px] text-[#C6A15B] font-mono font-bold">Password: bsc@2026</div>
                  </div>
                  <div className="p-3 bg-white rounded-xl border border-[#EAE4DC]">
                    <div className="text-[10px] font-black text-[#777777] uppercase">HR Specialist</div>
                    <div className="font-extrabold text-[#4A1726] font-mono mt-0.5">hr@bsctextiles.com</div>
                    <div className="text-[11px] text-[#C6A15B] font-mono font-bold">Password: bsc@2026</div>
                  </div>
                  <div className="p-3 bg-white rounded-xl border border-[#EAE4DC]">
                    <div className="text-[10px] font-black text-[#777777] uppercase">Store Manager</div>
                    <div className="font-extrabold text-[#4A1726] font-mono mt-0.5">manager@bsctextiles.com</div>
                    <div className="text-[11px] text-[#C6A15B] font-mono font-bold">Password: bsc@2026</div>
                  </div>
                  <div className="p-3 bg-white rounded-xl border-2 border-emerald-500/40 bg-emerald-50/50">
                    ...
                    <div className="font-extrabold text-[#4A1726] font-mono mt-0.5">greeter@bsctextiles.com</div>
              ...
              <div className="card-glass p-5 space-y-4">
                <h3 className="font-extrabold text-[#4A1726] text-sm tracking-tight">Registered User Accounts &amp; Role Management</h3>
                    ...
                    <tbody className="divide-y divide-[#EAE4DC]/60">
                      {users.map(u => (
                        <tr key={u.username} className="hover:bg-black/5 font-medium">
                          <td className="py-3.5 px-4 font-extrabold text-[#4A1726]">{u.fullName}</td>
                          ...
                          <td className="py-3.5 px-4">
                            {u.location_id === null || u.location_id === undefined ? (
                              ...
                              <span className="px-2.5 py-1 rounded-full text-xs font-bold bg-[#4A1726]/10 text-[#4A1726] flex items-center gap-1 w-fit">
                          ...
                          <td className="py-3.5 px-4">
                            <select
                              ...
                              className="p-1.5 rounded-xl border border-[#4A1726]/30 bg-white font-bold text-[#4A1726] text-xs shadow-xs"
                            >
                          ...
                          <td className="py-3.5 px-4 text-right">
                            <div className="flex items-center justify-end gap-2">
                              ...
                              <button
                                ...
                                className="px-3 py-1.5 rounded-xl border border-[#4A1726] text-[#4A1726] font-bold text-[11px] hover:bg-[#4A1726] hover:text-white transition-all flex items-center gap-1 shadow-xs"
                              >
          ...
          {activeTab === 'pins' && (
            <div className="space-y-6 animate-fade-in">
              <div className="card-glass p-6 space-y-6">
                <div>
                  <h3 className="font-extrabold text-[#4A1726] text-base flex items-center gap-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div className="p-5 rounded-2xl bg-[#F8F5F1] border border-[#EAE4DC] space-y-4">
                    <div>
                      <div className="font-extrabold text-sm text-[#4A1726]">Entrance Greeter Kiosk PIN</div>
                    ...
                    <div className="space-y-1.5">
                      ...
                      <div className="relative">
                        <input
                          ...
                          className="input-modern font-mono text-sm tracking-wider pr-10 font-black text-[#4A1726]"
                        />
                        <button
                          type="button"
                  ...
                  <div className="p-5 rounded-2xl bg-[#F8F5F1] border border-[#EAE4DC] space-y-4">
                    <div>
                      <div className="font-extrabold text-sm text-[#4A1726]">Live Store TV Screen PIN</div>
                  ...
                  <div className="p-5 rounded-2xl bg-[#F8F5F1] border border-[#EAE4DC] space-y-4">
                    <div>
                      <div className="font-extrabold text-sm text-[#4A1726]">Cash Settlement Desk PIN</div>
                ...
                <div className="flex justify-end pt-2 border-t border-[#EAE4DC]">
                  <button
          ...
          {activeTab === 'visibility' && (
            <div className="card-glass p-6 space-y-5 animate-fade-in">
              <div className="flex justify-between items-center border-b border-[#EAE4DC] pb-3">
                <div>
                  <h3 className="font-extrabold text-[#4A1726] text-base">Role-Based Page Visibility Matrix</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 text-xs">
                {['HR', 'Manager', 'Greeter', 'Recruiter', 'Interviewer'].map(roleName => (
                  <div key={roleName} className="p-4 rounded-2xl border border-[#EAE4DC] bg-[#F8F5F1] space-y-3">
                    <div className="font-black text-sm text-[#4A1726] border-b border-[#EAE4DC] pb-2 uppercase tracking-wider">{roleName} Access</div>
                    <div className="space-y-2">
                      {['dashboard', 'candidates', 'offer', 'openings', 'employees', 'dept_hiring', 'section_allocation', 'form', 'broadcast', 'settings'].map(pageKey => {
                        ...
                        return (
                          <label key={pageKey} className="flex items-center justify-between p-2 rounded-xl bg-white border border-[#EAE4DC] cursor-pointer font-bold text-[#4A1726]">
                            <span className="capitalize">{pageKey.replace('_', ' ')} Module</span>
                            <input
                              type="checkbox"
                              checked={allowed}
                              onChange={(e) => setPageSettings({ ...pageSettings, [key]: e.target.checked })}
                              className="accent-[#4A1726] rounded"
                            />
                          </label>
                        );
                      })}
          ...
          {activeTab === 'questions' && (
            <div className="space-y-6 animate-fade-in">
              <div className="card-glass p-6 space-y-4">
                <h3 className="font-extrabold text-[#4A1726] text-sm uppercase tracking-wider">Add Interview Rubric Question</h3>
              ...
              <div className="card-glass p-5 space-y-4">
                <h3 className="font-extrabold text-[#4A1726] text-sm">Active Evaluation Questions</h3>
                <div className="space-y-2 text-xs">
                  {questions.map((q) => (
                    <div key={q.id} className="p-3.5 rounded-xl border border-[#EAE4DC] bg-[#F8F5F1] flex items-center justify-between gap-3">
                      <div>
                        <div className="font-extrabold text-[#4A1726]">{q.question}</div>
          ...
          {activeTab === 'roles' && (
            <div className="card-glass p-6 space-y-5 animate-fade-in">
              <h3 className="font-extrabold text-[#4A1726] text-sm uppercase tracking-wider">Company Designations Master List</h3>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs pt-2">
                {designations.map((d) => (
                  <div key={d} className="p-3 rounded-xl border border-[#EAE4DC] bg-[#F8F5F1] flex items-center justify-between font-bold text-[#4A1726]">
                    <span>{d}</span>
