...
export default function Greeter() {
  ...
  if (!authenticated) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#280B14] via-[#4A1726] to-[#350E1A] flex items-center justify-center p-4 relative overflow-hidden">
        {/* Ambient Glows */}
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-[#C6A15B]/10 rounded-full blur-3xl pointer-events-none"></div>
        ...
        <div className="bg-white/10 backdrop-blur-2xl p-8 max-w-md w-full text-center space-y-6 animate-scale-in border border-white/20 rounded-3xl shadow-2xl relative z-10 text-white">
          <div className="w-16 h-16 bg-gradient-to-br from-[#4A1726] to-[#280B14] text-[#C6A15B] rounded-3xl flex items-center justify-center mx-auto shadow-xl border border-white/10">
          ...
          <form onSubmit={handleVerifyPin} className="space-y-4">
            <div className="relative max-w-xs mx-auto">
              <input
                ...
                className="w-full text-center tracking-[1em] text-2xl font-black py-3 rounded-2xl border border-white/20 bg-white/10 text-white focus:outline-none focus:border-[#C6A15B] focus:ring-2 focus:ring-[#C6A15B]/30 transition-all placeholder:text-white/30"
              />
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#280B14] via-[#4A1726] to-[#350E1A] text-white p-4 sm:p-6 flex flex-col justify-between max-w-xl mx-auto select-none relative overflow-hidden">
      {/* Background Ambient Glows */}
      <div className="absolute top-10 -left-20 w-80 h-80 bg-[#C6A15B]/10 rounded-full blur-3xl pointer-events-none"></div>
