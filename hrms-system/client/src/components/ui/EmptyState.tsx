...
export default function EmptyState({
  ...
  return (
    <div className="card-glass p-8 sm:p-12 text-center flex flex-col items-center justify-center my-4">
      <div className="w-16 h-16 rounded-2xl bg-[#4A1726]/5 border border-[#4A1726]/10 flex items-center justify-center text-[#4A1726] mb-4 shadow-sm">
        <Icon className="w-8 h-8 stroke-[1.5]" />
      </div>
      <h3 className="text-base font-extrabold text-[#4A1726]">{title}</h3>
