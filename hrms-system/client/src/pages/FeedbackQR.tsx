    ...
    <DashboardLayout title="Feedback QR Code Portal" subtitle="POS & Checkout Counter Customer Survey QR Display">
      <div className="max-w-xl mx-auto space-y-6 text-center">
        <div className="card-glass p-8 space-y-6">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#4A1726] text-[#C6A15B] text-xs font-extrabold uppercase tracking-widest">
            <Sparkles className="w-4 h-4" />
            <span>Store Tablet Kiosk Ready</span>
          </div>

          <h2 className="text-2xl font-black text-[#4A1726]">Scan to Share Your Feedback</h2>
          ...
          <div className="p-6 bg-white rounded-3xl shadow-xl border border-gray-200 inline-block mx-auto">
            ...
            />
            <div className="mt-4 font-black text-xs text-[#4A1726] uppercase tracking-wider">
              BSC EXCLUSIVE DAVANAGERE
            </div>
          </div>

          {/* URL Controls */}
          <div className="flex items-center gap-2 bg-[#F8F5F1] p-3 rounded-xl border max-w-md mx-auto">
