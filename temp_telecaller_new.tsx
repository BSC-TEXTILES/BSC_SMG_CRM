            ...
            <div className="bg-white rounded-xl shadow-sm border border-[#EBE5E0] overflow-hidden">
              <table className="w-full text-left border-collapse">
                ...
                <tbody className="divide-y divide-[#EBE5E0]">
                  {filtered.map(c => (
                    <tr key={c.id} className="hover:bg-[#FDFCFB] cursor-pointer transition-colors" onClick={() => setDetailCustomer(c)}>
                      ...
                      <td className="py-4 px-5">
                        <div className="text-xs font-extrabold text-[#2C1E16]">{c.customerName}</div>
                      ...
                      <td className="py-4 px-5">
                        ...
                        <div className="text-[10px] text-[#9A8F85] font-semibold mt-0.5">{c.locationName}</div>
                      </td>
                      <td className="py-4 px-5">
                      ...
                      <td className="py-4 px-5">
                        <div className="text-xs font-black text-[#2C1E16]">{c.totalCalls || 0} Calls Made</div>
                      </td>
                      <td className="py-4 px-5">
                        <div className="flex items-center gap-2">
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-[850px] flex flex-col overflow-hidden animate-in zoom-in-95 duration-200">
            ...
            <div className="px-6 py-4 bg-[#4A1E2C] flex items-center justify-between text-white">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="flex items-center gap-2">
                    <span className="text-[10px] font-bold tracking-widest text-amber-200 uppercase">{detailCustomer.id}</span>
                    <span className="bg-amber-500 text-[#4A1E2C] text-[9px] font-black px-1.5 py-0.5 rounded uppercase">VIP Confirmed</span>
                  </div>
                  <h2 className="text-xl font-extrabold">{detailCustomer.brideGroom}</h2>
                </div>
              </div>
              <div className="flex items-center gap-3">
