      ...
      <div className="space-y-6">
        ...
        <div className="card-glass overflow-hidden">
          <div className="p-5 border-b border-[#EAE4DC] flex items-center justify-between">
            <h3 className="font-extrabold text-sm text-[#4A1726] uppercase tracking-wider flex items-center gap-2">
              <PhoneCall className="w-4 h-4 text-[#C6A15B]" />
              <span>Feedback Call Queue Register ({callQueue.length})</span>
            </h3>
            <button onClick={fetchCallQueue} className="text-xs font-bold text-[#C6A15B] hover:underline flex items-center gap-1">
          ...
          {loading ? (
            ...
            <div className="py-12 text-center text-gray-500 font-bold text-xs space-y-2">
              ...
              <div className="text-sm text-[#4A1726] font-black">No Pending Follow-up Calls</div>
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left text-xs font-semibold border-collapse">
                <thead className="bg-[#4A1726] text-white uppercase text-[10.5px] tracking-wider">
                  <tr>
                  ...
                  {callQueue.map((item) => {
                    ...
                    return (
                      <tr key={item.id} className="hover:bg-black/5 transition-colors">
                        ...
                        <td className="p-4 font-extrabold text-[#4A1726]">
        ...
        {selectedItem && (
          <div className="fixed inset-0 bg-[#4A1726]/70 backdrop-blur-md flex items-center justify-center p-4 z-50 animate-fade-in">
            <div className="card-glass p-6 sm:p-8 max-w-lg w-full space-y-5 animate-scale-in shadow-2xl rounded-3xl border border-white/40 bg-white text-[#4A1726] max-h-[90vh] overflow-y-auto">
              
              <div className="flex items-center justify-between border-b border-[#EAE4DC] pb-3">
                <h3 className="text-lg font-black text-[#4A1726] flex items-center gap-2">
              ...
              <div className="p-4 rounded-2xl bg-[#F8F5F1] border border-[#EAE4DC] space-y-1">
                <div className="text-[10px] font-black uppercase tracking-wider text-[#C6A15B]">Customer Context</div>
                <div className="font-extrabold text-sm text-[#4A1726] flex items-center justify-between">
              ...
              <div className="space-y-4">
                ...
                {/* Call Outcome Select */}
                <div>
                  <label className="block text-xs font-extrabold text-[#4A1726] mb-1.5">Call Outcome *</label>
                  <select
                    value={callOutcome}
                ...
                <div>
                  <label className="block text-xs font-extrabold text-[#4A1726] mb-1.5">Issue Category *</label>
                  <select
                    value={issueCategory}
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <label className="block text-xs font-extrabold text-[#4A1726] mb-1.5">Next Follow-Up Date</label>
                    <input
                      type="date"
                  ...
                  <div>
                    <label className="block text-xs font-extrabold text-[#4A1726] mb-1.5">Next Follow-Up Time</label>
                    <input
                      type="time"
                ...
                {/* Call Notes */}
                <div>
                  <label className="block text-xs font-extrabold text-[#4A1726] mb-1.5">Telecaller Resolution & Call Remarks *</label>
                  <textarea
                    rows={3}
                    value={notes}
                ...
                {selectedItem.notes && (
                  <div className="space-y-1.5 pt-2 border-t border-[#EAE4DC]">
                    <div className="text-[10.5px] font-black uppercase text-[#777777] tracking-wider flex items-center gap-1">
                      <History className="w-3.5 h-3.5 text-[#C6A15B]" /> Call Log History
                    </div>
                ...
                <div className="flex flex-wrap items-center justify-between gap-2 pt-3 border-t border-[#EAE4DC]">
                  <button
                    onClick={() => setSelectedItem(null)}
