...
export default function CandidateEntryPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F8F5F1] pb-12">
      ...
      {/* Modern Header */}
      <header className="bg-[#4A1726] p-4 sm:p-5 text-white shadow-lg sticky top-0 z-30 border-b border-[#C6A15B]/30">
      ...
      <div className="max-w-3xl mx-auto p-4 sm:p-6 space-y-6">
        ...
        {step !== 3 && (
          <div className="card-glass p-4 text-xs font-extrabold space-y-2">
            <div className="flex items-center justify-between">
              <div className={`flex items-center gap-2 ${step === 1 ? 'text-[#4A1726]' : 'text-emerald-700'}`}>
                <span className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-black transition-all ${step === 1 ? 'bg-[#4A1726] text-white shadow-md ring-2 ring-[#C6A15B]' : 'bg-emerald-600 text-white'}`}>
                  {step > 1 ? '✓' : '1'}
                </span>
              ...
              <div className={`flex items-center gap-2 ${step === 2 ? 'text-[#4A1726]' : 'text-[#888888]'}`}>
                <span className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-black transition-all ${step === 2 ? 'bg-[#4A1726] text-white shadow-md ring-2 ring-[#C6A15B]' : 'bg-[#F8F5F1] border border-[#EAE4DC]'}`}>
                  2
                </span>
            ...
            <div className="h-1.5 w-full bg-[#EAE4DC] rounded-full overflow-hidden">
              <div
                className="h-full bg-gradient-to-r from-[#4A1726] to-[#C6A15B] transition-all duration-500 ease-out"
        ...
        {step === 1 && (
          <div className="card-glass p-6 sm:p-8 space-y-6 animate-fade-in shadow-xl">
            ...
            <div className="space-y-4">
              <div className="border-b border-[#EAE4DC] pb-3 flex items-center gap-2">
                <User className="w-5 h-5 text-[#C6A15B]" />
                <h2 className="text-sm font-extrabold uppercase text-[#4A1726] tracking-wider">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs font-bold text-[#4A1726] mb-1">Full Name (As per Aadhaar) *</label>
                  <input
                    type="text"
                    value={name}
                ...
                <div>
                  <label className="block text-xs font-bold text-[#4A1726] mb-1">Mobile Phone Number *</label>
                  <div className="flex">
                    <span className="p-2.5 bg-[#EAE4DC]/50 border border-r-0 border-[#EAE4DC] rounded-l-xl font-extrabold text-xs text-[#555555] flex items-center">
                      +91
                    </span>
                    <input
                      type="tel"
                ...
                <div>
                  <label className="block text-xs font-bold text-[#4A1726] mb-1">Email Address (Optional)</label>
                  <input
                    type="email"
                    value={email}
                ...
                <div>
                  <label className="block text-xs font-bold text-[#4A1726] mb-1">Gender *</label>
                ...
                <div>
                  <label className="block text-xs font-bold text-[#4A1726] mb-1">Date of Birth *</label>
                  <input
                    type="date"
                    value={dob}
                ...
                <div>
                  <label className="block text-xs font-bold text-[#4A1726] mb-1">Blood Group *</label>
              ...
              <div>
                <label className="block text-xs font-bold text-[#4A1726] mb-1">Complete Residential Address *</label>
                <textarea
                  rows={2}
                  value={address}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs font-bold text-[#4A1726] mb-1">Aadhaar Number (12 Digits) *</label>
                  <input
                    type="text"
                    maxLength={12}
                    value={aadhaarNumber}
                ...
                <div>
                  <label className="block text-xs font-bold text-[#4A1726] mb-1">Religion *</label>
                ...
                <div>
                  <label className="block text-xs font-bold text-[#4A1726] mb-1">Caste / Category *</label>
                  <input
                    type="text"
                    value={caste}
                ...
                <div>
                  <label className="block text-xs font-bold text-[#4A1726] mb-1">Father's Name &amp; Occupation (Optional)</label>
                  <input
                    type="text"
                    value={fatherDetails}
                ...
                <div>
                  <label className="block text-xs font-bold text-[#4A1726] mb-1">Mother's Name &amp; Occupation (Optional)</label>
                  <input
                    type="text"
                    value={motherDetails}
              ...
              <div>
                <label className="block text-xs font-bold text-[#4A1726] mb-2">Languages Known *</label>
                <div className="flex flex-wrap gap-2">
                  {LANGUAGES.map(lang => (
                    <label key={lang} className="flex items-center gap-1.5 bg-[#F8F5F1] border border-[#EAE4DC] px-3.5 py-2 rounded-xl cursor-pointer font-semibold text-xs text-[#4A1726] hover:bg-white transition-colors">
                      <input
                        type="checkbox"
                        checked={languagesKnown.includes(lang)}
                        onChange={() => handleLangToggle(lang)}
                        className="rounded accent-[#4A1726]"
                      />
                      <span>{lang}</span>
                    </label>
                  ))}
            ...
            <div className="space-y-4 pt-4 border-t border-[#EAE4DC]">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs font-bold text-[#4A1726] mb-1">Position Applied For *</label>
                ...
                <div>
                  <label className="block text-xs font-bold text-[#4A1726] mb-1">Highest Qualification *</label>
                ...
                <div>
                  <label className="block text-xs font-bold text-[#4A1726] mb-1">Total Work Experience *</label>
                ...
                <div>
                  <label className="block text-xs font-bold text-[#4A1726] mb-1">Earliest Date of Joining (Earliest Availability)</label>
                  <input
                    type="date"
                    value={offeredDoj}
              ...
              <div className="space-y-2">
                <label className="block text-xs font-bold text-[#4A1726]">Prior work experience? *</label>
                <div className="space-y-2">
                  {[
                    ...
                    <label key={opt} className="flex items-center gap-2 p-3 rounded-xl border border-[#EAE4DC] bg-[#F8F5F1] cursor-pointer text-xs font-semibold text-[#4A1726] hover:bg-white transition-colors">
                      <input
                        type="radio"
                        name="retailExp"
                        value={opt}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs font-bold text-[#4A1726] mb-1">Previous Company / Store Name</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-xs font-bold text-[#4A1726] mb-1">Previous Designation / Role</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-xs font-bold text-[#4A1726] mb-1">Previous Salary (₹ Monthly)</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-xs font-bold text-[#4A1726] mb-1">Expected Salary (₹ Monthly)</label>
                  <input
                    type="text"
            ...
            {/* Actions */}
            <div className="flex justify-end pt-4 border-t border-[#EAE4DC]">
              <button
                type="button"
        ...
        {step === 2 && (
          <div className="card-glass p-6 sm:p-8 space-y-6 animate-fade-in shadow-xl">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              {/* Photo Upload */}
              <div className="p-4 rounded-2xl border-2 border-dashed border-[#EAE4DC] bg-[#F8F5F1] text-center space-y-2 hover:border-[#4A1726] transition-colors">
                <ImageIcon className="w-8 h-8 text-[#C6A15B] mx-auto" />
                <div className="font-extrabold text-xs text-[#4A1726]">Candidate Passport Photo *</div>
                <input
                  type="file"
                  accept="image/*"
                  ...
                  id="photo-input"
                />
                <label htmlFor="photo-input" className="inline-block px-3 py-1.5 rounded-lg bg-white border border-[#EAE4DC] text-xs font-bold text-[#4A1726] cursor-pointer hover:bg-[#4A1726] hover:text-white transition-colors">
              ...
              {/* Aadhaar Upload */}
              <div className="p-4 rounded-2xl border-2 border-dashed border-[#EAE4DC] bg-[#F8F5F1] text-center space-y-2 hover:border-[#4A1726] transition-colors">
                <FileCheck className="w-8 h-8 text-[#C6A15B] mx-auto" />
                <div className="font-extrabold text-xs text-[#4A1726]">Aadhaar Card (Front/Back) *</div>
                <input
                  type="file"
                  ...
                  id="aadhar-input"
                />
                <label htmlFor="aadhar-input" className="inline-block px-3 py-1.5 rounded-lg bg-white border border-[#EAE4DC] text-xs font-bold text-[#4A1726] cursor-pointer hover:bg-[#4A1726] hover:text-white transition-colors">
              ...
              {/* Resume Upload */}
              <div className="p-4 rounded-2xl border-2 border-dashed border-[#EAE4DC] bg-[#F8F5F1] text-center space-y-2 hover:border-[#4A1726] transition-colors">
                <FileText className="w-8 h-8 text-[#C6A15B] mx-auto" />
                <div className="font-extrabold text-xs text-[#4A1726]">Resume / CV Document *</div>
                <input
                  type="file"
                  ...
                  id="resume-input"
                />
                <label htmlFor="resume-input" className="inline-block px-3 py-1.5 rounded-lg bg-white border border-[#EAE4DC] text-xs font-bold text-[#4A1726] cursor-pointer hover:bg-[#4A1726] hover:text-white transition-colors">
            ...
            <div className="p-4 rounded-2xl bg-amber-50/60 border border-amber-200 space-y-2">
              <label className="flex items-start gap-3 cursor-pointer text-xs font-semibold text-[#4A1726]">
                <input
                  type="checkbox"
                  checked={declaration}
                  onChange={(e) => setDeclaration(e.target.checked)}
                  className="mt-0.5 rounded accent-[#4A1726]"
                />
                <span>
            ...
            <div className="flex items-center justify-between pt-4 border-t border-[#EAE4DC]">
              <button
                type="button"
                onClick={() => setStep(1)}
                className="px-4 py-2 rounded-xl border border-[#EAE4DC] text-xs font-bold text-[#4A1726] hover:bg-[#F8F5F1] flex items-center gap-1.5"
              >
        ...
        {step === 3 && (
          <div className="card-glass p-8 sm:p-12 text-center space-y-5 animate-fade-in shadow-2xl my-8">
            ...
            <div>
              <h2 className="text-2xl font-black text-[#4A1726] tracking-tight">Registration Successfully Submitted! 🎉</h2>
              <p className="text-sm text-[#777777] font-medium mt-1">Thank you for submitting your application to BSC The Textile Mall.</p>
            </div>

            <div className="p-4 rounded-2xl bg-[#4A1726]/5 border border-[#4A1726]/10 inline-block">
              <span className="text-xs uppercase font-black text-[#777777] block">Application Reference Number</span>
              <span className="text-2xl font-mono font-black text-[#4A1726] tracking-wider">{successAppNo}</span>
            </div>

            <div className="pt-4 border-t border-[#EAE4DC] flex justify-center gap-3">
              <button
