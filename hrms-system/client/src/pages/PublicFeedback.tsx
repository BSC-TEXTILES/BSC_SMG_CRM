...
export default function PublicFeedback() {
  ...
  const getOptionIcon = (opt: string) => {
    ...
    return <Star className="w-4 h-4 text-[#C6A15B] shrink-0" />;
  };

  if (submitted) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#350E1A] via-[#1F3A6E] to-[#280B14] flex items-center justify-center p-4 sm:p-6 select-none relative overflow-hidden text-white">
        {/* Background Ambient Glows */}
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-[#C6A15B]/15 rounded-full blur-3xl pointer-events-none"></div>
        ...
        <div className="bg-white/10 backdrop-blur-2xl p-8 sm:p-10 max-w-lg w-full text-center space-y-6 animate-scale-in border border-white/20 rounded-3xl shadow-2xl relative z-10">
          ...
          <div className="space-y-2">
            <div className="inline-flex items-center gap-1.5 px-3.5 py-1 rounded-full bg-[#350E1A] border border-[#C6A15B] text-[#C6A15B] text-[10.5px] font-black uppercase tracking-widest">
          ...
          <div className="p-4 rounded-2xl bg-white/5 border border-white/10 text-xs text-white/90 space-y-1">
            <div className="text-[10px] uppercase font-black tracking-widest text-[#C6A15B]">Survey Reference ID</div>
          ...
          <button
            ...
            className="w-full h-14 bg-gradient-to-r from-[#C6A15B] via-[#F3C04D] to-[#C6A15B] text-[#350E1A] font-black text-sm rounded-2xl shadow-xl active:scale-95 transition-all duration-150 border-2 border-amber-200/50"
          >
  ...
  return (
    <div className="min-h-screen bg-[#F8F5F1] py-5 sm:py-8 px-4 sm:px-6 flex justify-center selection:bg-[#C6A15B] selection:text-[#350E1A]">
      <div className="max-w-4xl w-full space-y-5">

        {/* Luxury Deep Navy to Royal Navy & Gold Hero Section (220-260px Height) */}
        <div className="p-6 sm:p-8 rounded-[24px] bg-gradient-to-br from-[#350E1A] via-[#1F3A6E] to-[#280B14] text-white border border-white/20 shadow-2xl relative overflow-hidden flex flex-col justify-between min-h-[230px] sm:min-h-[255px]">
          {/* Subtle Decorative Gold Highlight & Shapes */}
          <div className="absolute -top-20 -right-20 w-80 h-80 bg-[#C6A15B]/20 rounded-full blur-3xl pointer-events-none"></div>
          ...
          <div className="relative z-10 grid grid-cols-1 sm:grid-cols-3 gap-5 items-center">
            ...
            <div className="sm:col-span-2 space-y-2.5 text-center sm:text-left">
              <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-[#350E1A] text-[#C6A15B] text-[11px] font-black uppercase tracking-widest border border-[#C6A15B]/80 shadow-sm">
            ...
            <div className="sm:col-span-1 bg-white/10 backdrop-blur-md p-4 sm:p-5 rounded-2xl border border-white/20 flex items-center justify-between sm:flex-col sm:justify-center gap-3 text-center shadow-lg">
              ...
              <div className="relative w-16 h-16 sm:w-20 sm:h-20 flex items-center justify-center shrink-0">
                <svg className="w-full h-full transform -rotate-90" viewBox="0 0 36 36">
                  ...
                  />
                  <path
                    className="text-[#C6A15B] transition-all duration-500 ease-out"
                ...
                <div className="absolute flex flex-col items-center justify-center">
                  <span className="font-mono text-xs sm:text-sm font-black text-[#C6A15B] drop-shadow-xs">{progressStats.pct}%</span>
              ...
              <div className="text-right sm:text-center space-y-0.5 text-xs">
                <div className="flex items-center justify-end sm:justify-center gap-1 text-[11px] font-black text-[#C6A15B]">
          ...
          <div className="relative z-10 pt-4 border-t border-white/15 space-y-2">
            <div className="flex items-center justify-between text-[10.5px] font-extrabold text-white/90 overflow-x-auto gap-1.5 scrollbar-none">
              <span className={`px-2.5 py-0.5 rounded-full whitespace-nowrap ${customerName && mobile ? 'bg-[#C6A15B] text-[#350E1A] font-black' : 'bg-white/10 text-white/80'}`}>
                Details
              </span>
              <span className="text-white/40">·</span>
              <span className={`px-2.5 py-0.5 rounded-full whitespace-nowrap ${answers['q1'] ? 'bg-[#C6A15B] text-[#350E1A] font-black' : 'bg-white/10 text-white/80'}`}>
                Shopping
              </span>
              <span className="text-white/40">·</span>
              <span className={`px-2.5 py-0.5 rounded-full whitespace-nowrap ${answers['q2'] || answers['q3'] ? 'bg-[#C6A15B] text-[#350E1A] font-black' : 'bg-white/10 text-white/80'}`}>
                Product
              </span>
              <span className="text-white/40">·</span>
              <span className={`px-2.5 py-0.5 rounded-full whitespace-nowrap ${answers['q4'] ? 'bg-[#C6A15B] text-[#350E1A] font-black' : 'bg-white/10 text-white/80'}`}>
                Staff
              </span>
              <span className="text-white/40">·</span>
              <span className={`px-2.5 py-0.5 rounded-full whitespace-nowrap ${answers['q5'] ? 'bg-[#C6A15B] text-[#350E1A] font-black' : 'bg-white/10 text-white/80'}`}>
                Recommendation
              </span>
              <span className="text-white/40">·</span>
              <span className={`px-2.5 py-0.5 rounded-full whitespace-nowrap ${likedMost || canImprove ? 'bg-[#C6A15B] text-[#350E1A] font-black' : 'bg-white/10 text-white/80'}`}>
                Feedback
              </span>
            </div>

            {/* Dark Navy Track & Gold Progress Line */}
            <div className="w-full h-2.5 bg-[#350E1A]/80 rounded-full overflow-hidden p-0.5 border border-white/10">
              <div
                className="h-full bg-gradient-to-r from-[#C6A15B] via-[#F3C04D] to-amber-300 rounded-full transition-all duration-300 shadow-md"
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="card-glass p-6 sm:p-8 rounded-[22px] space-y-4 border border-white/80 bg-white/95 shadow-lg border-t-4 border-t-[#C6A15B]">
            <div className="flex items-center justify-between border-b border-[#EAE4DC] pb-3">
              <h3 className="font-black text-[#350E1A] text-xs sm:text-sm uppercase tracking-wider flex items-center gap-2">
                <div className="bg-[#C6A15B]/15 p-1.5 rounded-xl text-[#350E1A]">
                  <Lock className="w-4 h-4 text-[#C6A15B]" />
                </div>
                <span>Customer Verification Details</span>
              </h3>
              <span className="text-[10.5px] font-black text-[#C6A15B] uppercase tracking-wider bg-[#350E1A] px-2.5 py-1 rounded-full">Required Verification *</span>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-1.5">
                <label className="block text-xs font-extrabold text-[#350E1A]">Full Name *</label>
                <div className="relative">
                  <div className="absolute left-3.5 top-1/2 -translate-y-1/2 bg-[#C6A15B]/15 p-1.5 rounded-xl text-[#350E1A]">
                    <User className="w-4 h-4 text-[#350E1A]" />
                  </div>
                  <input
                    type="text"
                    required
                    ...
                    className="w-full text-xs font-semibold pl-12 pr-4 h-14 rounded-2xl border border-[#EAE4DC] bg-white/95 text-[#350E1A] outline-none focus:border-[#C6A15B] focus:ring-2 focus:ring-[#C6A15B]/30 transition-all shadow-xs"
                  />
                </div>
              </div>

              <div className="space-y-1.5">
                <label className="block text-xs font-extrabold text-[#350E1A]">Mobile Number *</label>
                <div className="relative">
                  <div className="absolute left-3.5 top-1/2 -translate-y-1/2 bg-[#C6A15B]/15 p-1.5 rounded-xl text-[#350E1A]">
                    <Phone className="w-4 h-4 text-[#350E1A]" />
                  </div>
                  <input
                    type="tel"
                    required
                    ...
                    className="w-full text-xs font-mono font-semibold pl-12 pr-4 h-14 rounded-2xl border border-[#EAE4DC] bg-white/95 text-[#350E1A] outline-none focus:border-[#C6A15B] focus:ring-2 focus:ring-[#C6A15B]/30 transition-all shadow-xs"
                  />
                </div>
          ...
          <div className="space-y-5">
            {questions.map((q: any, idx: number) => {
              ...
              return (
                <div key={q.id || idx} className="card-glass p-7 sm:p-8 rounded-[22px] space-y-4 border border-white/90 bg-white/95 shadow-lg border-t-4 border-t-[#C6A15B]">

                  {/* Section Badge Pill */}
                  <div className="flex items-center justify-between border-b border-[#EAE4DC] pb-3">
                    <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#350E1A] text-[#C6A15B] text-[10.5px] font-black uppercase tracking-widest">
                  ...
                  <h3 className="text-xl sm:text-[22px] font-black text-[#350E1A] leading-snug">
                    {cleanTitle}
                  </h3>
                      ...
                      return (
                        <button
                          ...
                          className={`
                            ...
                            ${isSelected
                              ? 'bg-[#350E1A] text-white border-2 border-[#C6A15B] shadow-xl shadow-[#350E1A]/20 scale-[1.01]'
                              : 'bg-white/95 text-[#350E1A] border-[#EAE4DC] hover:bg-white hover:border-[#350E1A]'}
                          `}
                        >
          ...
          <div className="card-glass p-7 sm:p-8 rounded-[22px] space-y-5 border border-white/90 bg-white/95 shadow-lg border-t-4 border-t-[#C6A15B]">
            <div className="flex items-center justify-between border-b border-[#EAE4DC] pb-3">
              <h3 className="font-black text-[#350E1A] text-xs sm:text-sm uppercase tracking-wider flex items-center gap-2">
            ...
            <div className="space-y-4">
              <div className="p-4 rounded-2xl bg-emerald-500/5 border border-emerald-300/60 space-y-2">
                ...
                <textarea
                  ...
                  className="w-full text-xs font-medium p-3.5 rounded-xl border border-emerald-200 bg-white text-[#350E1A] outline-none focus:ring-2 focus:ring-emerald-400/30 transition-all"
                ></textarea>
              </div>
              ...
              <div className="p-4 rounded-2xl bg-amber-500/5 border border-amber-300/60 space-y-2">
                ...
                <textarea
                  ...
                  className="w-full text-xs font-medium p-3.5 rounded-xl border border-amber-200 bg-white text-[#350E1A] outline-none focus:ring-2 focus:ring-amber-400/30 transition-all"
                ></textarea>
              </div>
              ...
              <div className="p-4 rounded-2xl bg-blue-500/5 border border-blue-300/60 space-y-2">
                ...
                <textarea
                  ...
                  className="w-full text-xs font-medium p-3.5 rounded-xl border border-blue-200 bg-white text-[#350E1A] outline-none focus:ring-2 focus:ring-blue-400/30 transition-all"
                ></textarea>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-3 pt-2">
            <button
              type="submit"
              disabled={submitting}
              className="w-full h-[58px] bg-gradient-to-r from-[#C6A15B] via-[#F3C04D] to-[#C6A15B] text-[#350E1A] font-black text-base sm:text-lg rounded-2xl shadow-2xl border-2 border-amber-200/50 flex items-center justify-center gap-2.5 hover:brightness-105 active:scale-95 transition-all duration-150"
            >
