...
export default function TVDisplay() {
  ...
  if (!authenticated) {
    return (
      <div className="min-h-screen bg-[#4A1726] flex items-center justify-center p-4">
        <div className="card-glass p-8 max-w-md w-full text-center space-y-6 animate-scale-in">
          <div className="w-16 h-16 bg-[#C6A15B] text-white rounded-3xl flex items-center justify-center mx-auto shadow-lg">
            <Tv className="w-8 h-8" />
          </div>
          <div>
            <h2 className="text-2xl font-black text-[#4A1726]">Store TV Display Gate</h2>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#280B14] via-[#4A1726] to-[#350E1A] text-white p-6 sm:p-8 flex flex-col justify-between overflow-hidden select-none">
      {/* Top Monitor Header */}
      <div className="flex items-center justify-between border-b border-white/15 pb-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <div className="text-xs font-extrabold text-[#C6A15B] uppercase tracking-widest mt-0.5 flex items-center gap-2">
