      ...
      <DashboardLayout title="Cash Settlement Desk" subtitle="Daily POS Billing Counter Settlement & Cashier Reconciliation">
        <div className="max-w-md mx-auto my-12">
          <div className="card-glass p-8 text-center space-y-6 animate-scale-in">
            <div className="w-16 h-16 bg-[#4A1726] text-[#C6A15B] rounded-3xl flex items-center justify-center mx-auto shadow-lg">
              <Lock className="w-8 h-8" />
            </div>
            <div>
              <h2 className="text-2xl font-black text-[#4A1726]">Cash Desk Locked</h2>
      ...
      <form onSubmit={handleSave} className="space-y-6">
        ...
        <div className="card-glass p-6 flex flex-wrap items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <label className="block text-xs font-extrabold uppercase text-[#4A1726]/60 tracking-wider">Settlement Date</label>
              <input
                type="date"
                value={date}
          ...
          <div className="flex items-center gap-6 bg-[#4A1726] text-white px-6 py-3 rounded-2xl">
            <div>
        ...
        <div className="card-glass p-6 space-y-4">
          <h3 className="text-sm font-extrabold text-[#4A1726] uppercase tracking-wider border-b pb-2">Day Settlement Summary</h3>
          <div className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-5 gap-4">
            <div>
              ...
              <input
                ...
                className="input-modern font-black text-lg text-[#4A1726]"
              />
            </div>
