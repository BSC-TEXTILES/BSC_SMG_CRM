  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6 bg-[#4A1726]/70 backdrop-blur-md transition-all animate-fade-in select-none">
      <div className="relative w-full max-w-4xl max-h-[92vh] bg-[#F8F5F1] rounded-3xl shadow-2xl flex flex-col z-10 overflow-hidden border-2 border-[#C6A15B]/50">
        ...
        {/* Tabs Bar */}
        <div className="flex items-center gap-2 p-2 sm:px-6 bg-white border-b border-[#EAE4DC] overflow-x-auto text-xs font-bold scrollbar-none sticky top-0 z-10 shadow-xs">
          {[
          ...
          {!isEditing ? (
                ...
                <div className="space-y-4 animate-fade-in">
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                    ...
                    <div className="p-4 rounded-2xl bg-white border border-[#EAE4DC] shadow-xs space-y-1">
                      ...
                      <div className="text-base font-extrabold text-[#4A1726]">
                  ...
                  <div className="p-5 rounded-2xl bg-white border border-[#EAE4DC] shadow-xs space-y-3">
                    ...
                    <div className="grid grid-cols-3 gap-3 text-center">
                      <div className="bg-[#F8F5F1] p-3 rounded-xl border border-[#EAE4DC]">
                        <div className="text-[9px] uppercase font-black text-[#777777] mb-0.5">Base Salary</div>
                        <div className="text-base font-bold text-[#4A1726] font-mono">₹{sal.base.toLocaleString('en-IN')}</div>
                      </div>
                  ...
                  <div className="p-5 rounded-2xl bg-white border border-[#EAE4DC] shadow-xs space-y-3">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
                      <div><span className="text-[#777777] block text-[10.5px] font-bold">Department</span><span className="font-extrabold text-[#4A1726] text-sm">{dept}</span></div>
                      <div><span className="text-[#777777] block text-[10.5px] font-bold">Floor Section</span><span className="font-extrabold text-[#C6A15B] text-sm">{section}</span></div>
                      <div><span className="text-[#777777] block text-[10.5px] font-bold">Designation Role</span><span className="font-extrabold text-[#4A1726]">{desig}</span></div>
                      <div><span className="text-[#777777] block text-[10.5px] font-bold">Reporting Manager</span><span className="font-extrabold text-[#4A1726]">{currentEmp.reportingManager || currentEmp.reporting_manager || 'Store Manager'}</span></div>
                      <div><span className="text-[#777777] block text-[10.5px] font-bold">Store Branch</span><span className="font-extrabold text-[#4A1726]">{currentEmp.branch || 'BSC EXCLUSIVE DAVANAGERE'}</span></div>
                ...
                <div className="space-y-4 animate-fade-in">
                  <div className="p-5 rounded-2xl bg-white border border-[#EAE4DC] shadow-xs space-y-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div><span className="text-[#777777] block text-[10.5px] font-bold">Full Name</span><span className="font-extrabold text-[#4A1726] text-sm">{empName}</span></div>
                      <div><span className="text-[#777777] block text-[10.5px] font-bold">Gender</span><span className="font-extrabold text-[#4A1726]">{currentEmp.gender || '—'}</span></div>
                      <div><span className="text-[#777777] block text-[10.5px] font-bold">Date of Birth (DOB)</span><span className="font-extrabold text-[#4A1726]">{currentEmp.dob || '—'}</span></div>
                      <div><span className="text-[#777777] block text-[10.5px] font-bold">Blood Group</span><span className="font-black text-rose-700">{currentEmp.bloodGroup || currentEmp.blood_group || '—'}</span></div>
                      <div><span className="text-[#777777] block text-[10.5px] font-bold">Religion & Caste</span><span className="font-extrabold text-[#4A1726]">{currentEmp.religion || '—'} {currentEmp.caste ? `(${currentEmp.caste})` : ''}</span></div>
                      <div><span className="text-[#777777] block text-[10.5px] font-bold">Languages Spoken</span><span className="font-extrabold text-[#4A1726]">{currentEmp.languagesKnown || currentEmp.languages_known || 'Kannada, English, Hindi'}</span></div>
                    </div>
                  </div>
                  ...
                  <div className="p-5 rounded-2xl bg-white border border-[#EAE4DC] shadow-xs space-y-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div><span className="text-[#777777] block text-[10.5px] font-bold">Mobile Phone</span><span className="font-extrabold text-[#4A1726]">{currentEmp.phone || '—'}</span></div>
                      <div><span className="text-[#777777] block text-[10.5px] font-bold">Email Address</span><span className="font-extrabold text-[#4A1726]">{currentEmp.email || '—'}</span></div>
                      <div><span className="text-[#777777] block text-[10.5px] font-bold">Father's Details</span><span className="font-extrabold text-[#4A1726]">{currentEmp.fatherDetails || currentEmp.father_details || '—'}</span></div>
                      <div><span className="text-[#777777] block text-[10.5px] font-bold">Mother's Details</span><span className="font-extrabold text-[#4A1726]">{currentEmp.motherDetails || currentEmp.mother_details || '—'}</span></div>
                      <div className="sm:col-span-2"><span className="text-[#777777] block text-[10.5px] font-bold">Residential Address</span><span className="font-extrabold text-[#4A1726]">{currentEmp.address || currentEmp.cityState || 'Davanagere, Karnataka'}</span></div>
                    </div>
                  </div>
                </div>
              )}
              ...
              {activeTab === 'professional' && (
                <div className="space-y-4 animate-fade-in">
                  <div className="p-5 rounded-2xl bg-white border border-[#EAE4DC] shadow-xs space-y-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div><span className="text-[#777777] block text-[10.5px] font-bold">Total Experience</span><span className="font-extrabold text-[#4A1726]">{currentEmp.experience || '—'}</span></div>
                      <div><span className="text-[#777777] block text-[10.5px] font-bold">Retail Industry Experience</span><span className="font-extrabold text-[#4A1726]">{currentEmp.retailExperience || currentEmp.retail_experience || '—'}</span></div>
                      <div><span className="text-[#777777] block text-[10.5px] font-bold">Previous Company</span><span className="font-extrabold text-[#4A1726]">{currentEmp.previousCompany || currentEmp.previous_company || '—'}</span></div>
                      <div><span className="text-[#777777] block text-[10.5px] font-bold">Previous Role / Designation</span><span className="font-extrabold text-[#4A1726]">{currentEmp.previousDesignation || currentEmp.previous_designation || '—'}</span></div>
                      <div><span className="text-[#777777] block text-[10.5px] font-bold">Previous Base Salary</span><span className="font-extrabold text-[#4A1726]">{currentEmp.previousSalary || currentEmp.previous_salary || '—'}</span></div>
                      <div><span className="text-[#777777] block text-[10.5px] font-bold">Highest Qualification</span><span className="font-extrabold text-[#4A1726]">{currentEmp.qualification || '—'}</span></div>
                    </div>
                    <div className="pt-2 border-t border-[#EAE4DC]/60">
                      <span className="text-[#777777] block text-[10.5px] mb-1 font-bold uppercase">Executive HR Remarks:</span>
                      <div className="p-3.5 rounded-xl bg-[#F8F5F1] border border-[#EAE4DC] text-xs font-semibold text-[#4A1726] italic">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      {fileUrl(currentEmp.photoUrl) && (
                        <a
                          ...
                          className="p-3 rounded-xl border border-[#EAE4DC] bg-[#F8F5F1] hover:bg-[#4A1726] hover:text-white transition-all flex items-center justify-between font-bold group"
                        >
                          <span>📷 Staff Profile Photo</span>
                          <ExternalLink className="w-4 h-4 text-[#C6A15B] group-hover:text-white" />
                        </a>
                      )}
            ...
            <div className="space-y-4 animate-fade-in bg-white p-5 rounded-2xl border border-[#C6A15B]/40 shadow-md">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
                <div>
                  <label className="block text-[11px] font-black text-[#4A1726] uppercase mb-1">Full Employee Name</label>
                  <input
                    type="text"
                    value={editForm.name}
                ...
                <div>
                  <label className="block text-[11px] font-black text-[#4A1726] uppercase mb-1">Allocated Department</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-[11px] font-black text-[#4A1726] uppercase mb-1">Assigned Floor Section</label>
                  <input
                    type="text"
                    value={editForm.section}
                    onChange={(e) => setEditForm({ ...editForm, section: e.target.value })}
                    className="w-full px-3 py-2 rounded-xl border border-[#EAE4DC] text-xs font-black text-[#C6A15B] outline-none focus:ring-2 focus:ring-[#C6A15B]/40"
                  />
                </div>

                <div>
                  <label className="block text-[11px] font-black text-[#4A1726] uppercase mb-1">Base Monthly Salary (₹)</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-[11px] font-black text-[#4A1726] uppercase mb-1">Monthly Incentive Bonus (₹)</label>
                  <input
                    type="text"
                    value={editForm.salaryInc}
                    onChange={(e) => setEditForm({ ...editForm, salaryInc: e.target.value })}
                    className="w-full px-3 py-2 rounded-xl border border-[#EAE4DC] text-xs font-mono font-bold text-emerald-700 outline-none focus:ring-2 focus:ring-[#C6A15B]/40"
                  />
                </div>
                ...
                <div>
                  <label className="block text-[11px] font-black text-[#4A1726] uppercase mb-1">Employment Status</label>
                  <select
                ...
                <div>
                  <label className="block text-[11px] font-black text-[#4A1726] uppercase mb-1">Date of Joining (DOJ)</label>
                  <input
                    type="date"
              ...
              <div>
                <label className="block text-[11px] font-black text-[#4A1726] uppercase mb-1">HR Executive Remarks</label>
                <textarea
                  rows={2}
