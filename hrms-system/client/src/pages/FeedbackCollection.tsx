      ...
      <div className="flex-1 lg:pl-64 flex flex-col min-w-0">
        ...
        <main className="p-4 lg:p-6 space-y-6 flex-1 overflow-y-auto">
          ...
          <div className="card-glass p-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div>
              <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#4A1726] text-[#C6A15B] text-[10px] font-black uppercase tracking-widest mb-1.5">
            ...
            <div className="flex items-center gap-2.5 w-full sm:w-auto justify-end">
              <button
                ...
                className="px-3.5 py-2 rounded-xl bg-white border border-[#EAE4DC] text-[#4A1726] text-xs font-extrabold hover:bg-gray-50 flex items-center gap-1.5 shadow-xs"
              >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="card-glass p-5 flex items-center justify-between">
              <div>
                ...
                <div className="text-2xl font-black text-[#4A1726] mt-1">{stats.total || feedbacks.length}</div>
              ...
              <div className="w-12 h-12 rounded-2xl bg-[#4A1726]/10 text-[#4A1726] flex items-center justify-center font-black">
                <MessageSquare className="w-6 h-6 text-[#4A1726]" />
              </div>
            </div>
          ...
          <div className="card-glass p-4 flex flex-col sm:flex-row items-center gap-3">
            ...
            <div className="flex items-center gap-2 w-full sm:w-auto">
              <Filter className="w-3.5 h-3.5 text-[#C6A15B] hidden sm:block" />
              <select
              ...
              {/* Date Preset Filter */}
              <Calendar className="w-3.5 h-3.5 text-[#C6A15B] hidden sm:block ml-2" />
              <select
                value={datePreset}
          ...
          <div className="card-glass p-5 space-y-4">
            <div className="flex items-center justify-between border-b border-[#EAE4DC] pb-3">
              <h3 className="font-extrabold text-[#4A1726] text-sm uppercase tracking-wider flex items-center gap-2">
            ...
            {loading ? (
              <div className="py-12 text-center text-xs font-bold text-gray-500 flex flex-col items-center gap-2">
                <RefreshCw className="w-6 h-6 animate-spin text-[#C6A15B]" />
              ...
              <div className="py-12 text-center text-xs font-bold text-gray-500 space-y-2">
                ...
                <div className="text-sm text-[#4A1726] font-extrabold">No Feedback Submissions Found</div>
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-left text-xs border-collapse">
                  <thead>
                    <tr className="border-b border-[#EAE4DC] text-[10.5px] font-black uppercase text-[#777777] bg-[#F8F5F1]/80">
                      ...
                      return (
                        <tr key={f.id} className="hover:bg-black/5 font-medium transition-colors">
                          <td className="py-3.5 px-4 text-[#555555]">
                            <div className="font-bold text-[#4A1726] font-mono text-[11px]">
                              {f.entryDate || 'Today'}
                            </div>
                            {f.entryTime && (
                          ...
                          <td className="py-3.5 px-4">
                            <div className="font-extrabold text-[#4A1726] flex items-center gap-1.5">
                          ...
                          <td className="py-3.5 px-4">
                            <span className="px-2.5 py-1 rounded-full text-[11px] font-extrabold bg-[#4A1726]/10 text-[#4A1726]">
                              {overallExp}
                            </span>
                          </td>
                          <td className="py-3.5 px-4">
                          ...
                          <td className="py-3.5 px-4 text-right">
                            <button
                              ...
                              className="px-3 py-1.5 rounded-xl border border-[#4A1726] text-[#4A1726] font-extrabold text-[11px] hover:bg-[#4A1726] hover:text-white transition-all flex items-center gap-1 ml-auto shadow-xs"
                            >
          ...
          {selectedFeedback && (
            <div className="fixed inset-0 bg-[#4A1726]/70 backdrop-blur-md z-50 flex items-center justify-center p-4 sm:p-6 overflow-y-auto animate-fade-in">
              <div className="card-glass max-w-5xl w-full p-6 sm:p-8 space-y-6 animate-scale-in max-h-[92vh] overflow-y-auto shadow-2xl rounded-3xl border border-white/40 bg-white/95 text-[#4A1726]">
                
                {/* 1. Header Redesign */}
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-[#EAE4DC] pb-5">
                  <div className="space-y-1">
                    <div className="flex flex-wrap items-center gap-2 mb-1.5">
                      ...
                      <span className="inline-flex items-center gap-1 px-3 py-1 rounded-full bg-[#4A1726] text-[#C6A15B] text-[10px] font-black uppercase tracking-widest">
                        BSC EXCLUSIVE RETAIL
                      </span>
                    </div>

                    <h2 className="text-2xl sm:text-3xl font-black tracking-tight text-[#4A1726]">
                ...
                <div className="space-y-2">
                  <h4 className="text-xs font-black uppercase tracking-wider text-[#4A1726]/70 flex items-center gap-1.5">
                    <Star className="w-3.5 h-3.5 text-[#C6A15B]" />
                    <span>Customer Satisfaction Summary</span>
                  </h4>

                  <div className="grid grid-cols-2 sm:grid-cols-5 gap-3">
                    <div className="p-3.5 rounded-2xl bg-white border border-[#EAE4DC] shadow-xs text-center">
                    ...
                    <div className="p-3.5 rounded-2xl bg-white border border-[#EAE4DC] shadow-xs text-center">
                      ...
                      <div className="text-sm font-black text-[#4A1726] mt-1.5">
                    ...
                    <div className="p-3.5 rounded-2xl bg-white border border-[#EAE4DC] shadow-xs text-center col-span-2 sm:col-span-1">
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    {[
                      ...
                      return (
                        <div key={idx} className="p-3.5 rounded-2xl bg-white border border-[#EAE4DC] flex items-center justify-between gap-3 shadow-xs">
                          <span className="text-xs font-bold text-[#4A1726] uppercase tracking-wider">
                            {qItem.label}
                          </span>
                ...
                {/* 6. Action Timeline */}
                <div className="space-y-3 pt-1 border-t border-[#EAE4DC]">
                  <h4 className="text-xs font-black uppercase tracking-wider text-[#4A1726]/70 flex items-center gap-1.5">
                    <Clock className="w-3.5 h-3.5 text-[#C6A15B]" />
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
                    <div className="p-3 rounded-2xl bg-[#F8F5F1] border border-[#EAE4DC] text-center">
                      ...
                      <div className="text-[11px] font-extrabold text-[#4A1726]">QR Submitted</div>
                    ...
                    <div className="p-3 rounded-2xl bg-[#F8F5F1] border border-[#EAE4DC] text-center">
                      ...
                      <div className="text-[11px] font-extrabold text-[#4A1726]">Feedback Recorded</div>
                    ...
                    <div className="p-3 rounded-2xl bg-[#F8F5F1] border border-[#EAE4DC] text-center">
                      ...
                      <div className="text-[11px] font-extrabold text-[#4A1726]">{selectedFeedback.isNegative ? 'Call Queue Added' : 'Survey Completed'}</div>
                      <div className="text-[9.5px] text-gray-500 mt-0.5">{selectedFeedback.isNegative ? 'Telecaller Pending' : 'CSAT Verified'}</div>
                    </div>

                    <div className="p-3 rounded-2xl bg-[#F8F5F1] border border-[#EAE4DC] text-center">
                      <div className="w-6 h-6 rounded-full bg-[#4A1726] text-[#C6A15B] font-bold text-xs flex items-center justify-center mx-auto mb-1">4</div>
                      <div className="text-[11px] font-extrabold text-[#4A1726]">Closed</div>
                ...
                <div className="p-5 rounded-2xl bg-[#F8F5F1] border border-[#EAE4DC] space-y-4">
                  <div className="flex items-center justify-between border-b border-[#EAE4DC] pb-2">
                    <h4 className="text-xs font-black uppercase tracking-wider text-[#4A1726] flex items-center gap-2">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-between gap-3 pt-4 border-t border-[#EAE4DC]">
                  <button
                    onClick={() => setSelectedFeedback(null)}
                    className="w-full sm:w-auto px-5 py-2.5 rounded-xl border border-[#EAE4DC] bg-[#F8F5F1] hover:bg-gray-100 text-[#555555] font-extrabold text-xs transition-all shadow-xs"
                  >
                    Close Dashboard
                  </button>
