  ...
  return (
    <div className="min-h-screen bg-[#F8F5F1] flex">
        ...
        <main className="p-4 lg:p-6 space-y-6 flex-1 overflow-y-auto pb-24">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-3">
              ...
              <div className="lg:col-span-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-8 pr-2.5 py-1.5 rounded-xl border border-[#EAE4DC] bg-[#F8F5F1] text-xs font-semibold text-[#4A1726] focus:outline-none focus:border-[#4A1726]"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-2.5 py-1.5 rounded-xl border border-[#EAE4DC] bg-[#F8F5F1] text-xs font-semibold text-[#4A1726] focus:outline-none focus:border-[#4A1726]"
                >
          ...
          <div className="card-glass p-5 space-y-4">
            <div className="flex items-center justify-between border-b border-[#EAE4DC] pb-3">
              <div>
                <h3 className="font-extrabold text-[#4A1726] text-base tracking-tight">Employee Directory &amp; Floor Section Assignment</h3>
              ...
              {selectedEmpIds.length > 0 && (
                <div className="text-xs font-extrabold text-[#4A1726] bg-[#C6A15B]/20 px-3 py-1 rounded-full border border-[#C6A15B]">
                      ...
                      <th className="py-3.5 px-3 text-center w-10">
                        <button onClick={toggleSelectAll} className="focus:outline-none">
                          {selectedEmpIds.length === filteredEmployees.length && filteredEmployees.length > 0 ? (
                            <CheckSquare className="w-4 h-4 text-[#4A1726]" />
                          ) : (
                ...
                <tbody className="divide-y divide-[#EAE4DC]/60">
                  {filteredEmployees.length > 0 ? (
                    filteredEmployees.map((emp, idx) => {
                      ...
                      return (
                        <tr key={emp.empId} className={`hover:bg-black/5 transition-colors font-medium ${isSelected ? 'bg-[#C6A15B]/10' : ''}`}>
                          ...
                          <td className="py-3.5 px-4">
                            ...
                            >
                              ...
                              <div>
                                <span className="font-black text-[#4A1726] group-hover:text-[#C6A15B] group-hover:underline block transition-colors">
                                  {emp.name}
                                </span>
                          ...
                          <td className="py-3.5 px-4 font-extrabold text-[#4A1726]">{emp.department}</td>
                            ...
                            {isHR ? (
                              <div className="flex items-center gap-2">
                                <select
                                  ...
                                  className="w-full px-2.5 py-1.5 rounded-xl border border-[#EAE4DC] bg-white text-xs font-bold text-[#4A1726] focus:border-[#4A1726] shadow-xs"
                                >
                              ...
                              <span className="font-bold text-[#C6A15B]">{emp.section || 'Unallocated'}</span>
                            )}
                          </td>
                          ...
                          <td className="py-3.5 px-4 font-extrabold text-[#4A1726]">{emp.salary}</td>
      ...
      {selectedEmpIds.length > 0 && isHR && (
        <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-40 bg-[#4A1726] text-white px-6 py-3.5 rounded-2xl shadow-2xl border border-amber-400/30 flex items-center gap-4 animate-bounce-subtle">
          <span className="text-xs font-bold">
            <span className="text-[#C6A15B] font-black">{selectedEmpIds.length}</span> Employees Selected
          </span>
          ...
          <button
            ...
            className="px-3.5 py-1.5 rounded-xl bg-[#C6A15B] text-white font-bold text-xs hover:bg-amber-600 transition-all shadow-xs flex items-center gap-1.5"
          >
            <Layers className="w-3.5 h-3.5" />
      ...
      {bulkModal.open && (
        <div className="fixed inset-0 z-50 bg-[#4A1726]/60 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="bg-[#F8F5F1] rounded-2xl border border-[#EAE4DC] shadow-2xl w-full max-w-md p-6 space-y-5">
            <div className="flex items-center justify-between border-b border-[#EAE4DC] pb-3">
              <div>
                <h3 className="font-extrabold text-[#4A1726] text-base">Bulk Section Allocation</h3>
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-3 py-2 rounded-xl border border-[#EAE4DC] bg-white font-bold text-xs shadow-xs"
                    >
