                      ...
                      <tr key={r.recordId} className="hover:bg-black/5 font-medium">
                        ...
                        <td className="py-3 px-3">
                          <div className="flex items-center gap-2">
                            <div className="w-24 bg-[#f0ede8] h-1.5 rounded-full overflow-hidden">
                              <div className="bg-[#C6A15B] h-full" style={{ width: `${r.progress}%` }} />
                            </div>
                        ...
                        <td className="py-3 px-3">
                          <button
                            ...
                            className="px-2.5 py-1 rounded bg-[#4A1726] text-white font-bold text-[11px]"
                          >
                            Open Checklist
                          </button>
                        </td>
      ...
      {drawerRecord && (
        <div className="fixed inset-0 z-50 flex justify-end">
          ...
          <div className="relative w-full max-w-lg bg-white h-full shadow-2xl flex flex-col z-10 animate-fade-in">
            <div className="bg-[#4A1726] p-5 text-white flex items-center justify-between">
              <div>
            ...
            <div className="flex-1 overflow-y-auto p-5 space-y-4 text-xs">
              {Object.keys(sections).map(sec => (
                <div key={sec} className="space-y-2">
                  <div className="text-[10px] font-black uppercase text-[#4A1726] tracking-wider p-2 bg-[#F8F5F1] rounded-md border-l-4 border-l-[#C6A15B]">
                    {sec}
                  </div>
      ...
      {newModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm">
          <div className="w-full max-w-md bg-white rounded-2xl p-5 space-y-4 shadow-2xl">
            <h3 className="font-black text-[#4A1726] text-base">New Onboarding</h3>
            ...
            <div className="flex justify-end gap-2 pt-2">
              ...
              <button onClick={handleCreateOnboarding} className="px-4 py-2 rounded-lg bg-[#4A1726] text-white text-xs font-bold">Create</button>
            </div>
          </div>
        </div>
      )}
